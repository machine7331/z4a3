...
#include "R3F_LOG_ENABLE.h"
	...
	R3F_LOG_FNCT_determiner_cout_chargement = compile preprocessFile "addons\r3f_log\fonctions_generales\determiner_cout_chargement.sqf";
	R3F_LOG_FNCT_calculer_chargement_vehicule = compile preprocessFile "addons\r3f_log\fonctions_generales\calculer_chargement_vehicule.sqf";
	...
	if !(isDedicated) then
	{
		...
		R3F_LOG_FNCT_remorqueur_remorquer_selection = compile preprocessFile "addons\r3f_log\remorqueur\remorquer_selection.sqf";
		R3F_LOG_FNCT_remorqueur_selectionner_objet = compile preprocessFile "addons\r3f_log\remorqueur\selectionner_objet.sqf";
		...
		R3F_LOG_FNCT_objet_init = compile preprocessFile "addons\r3f_log\objet_init.sqf";
